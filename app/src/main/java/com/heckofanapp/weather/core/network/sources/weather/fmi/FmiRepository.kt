package com.heckofanapp.weather.core.network.sources.weather.fmi
...
import com.heckofanapp.weather.data.local.mapper.weather.sources.fmi.toDomain
...
private fun getStartEndTimeForecast(
    location: Location,
): Pair<String, String> {
