package com.heckofanapp.weather.feature.blocks.screens.humidity
...
import com.heckofanapp.weather.core.ui.barColorsHumidity
        ...
        Column(
            ...
            LazyRow(
                ...
                items(
                    ...
                    val item = data[index]
                    val barColor = barColorsHumidity(item.humidity!!)
