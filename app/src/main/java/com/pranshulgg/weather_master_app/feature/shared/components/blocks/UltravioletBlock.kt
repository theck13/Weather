...
import com.pranshulgg.weather_master_app.core.model.weather.ultraviolet.getUltravioletIndex
...
fun UltravioletBlock(
    ...
    val ultravioletIndex =
        if (isDaily) {
            weather.daily[dailyIndex].ultravioletMaximum!!.roundToInt()
        } else {
            weather.current.ultraviolet!!.roundToInt()
        }
    val ultravioletIndexValue = getUltravioletIndex(ultravioletIndex)
        ...
        Box(
            ...
            Canvas(
                ...
                scale(
                    ...
                    drawCircle(
                        alpha = if (ultravioletIndexValue == UltravioletIndex.LOW) 1.00f else 0.15f,
                        center = Offset(
                            x = 31f,
                            y = 121f,
                        ),
                        color = Green400,
                        radius = if (ultravioletIndexValue == UltravioletIndex.LOW) 8.00f else 6.00f,
                    )

                    drawCircle(
                        alpha = if (ultravioletIndexValue == UltravioletIndex.MODERATE) 1.00f else 0.15f,
                        center = Offset(
                            x = 54f,
                            y = 145f,
                        ),
                        color = Yellow600,
                        radius = if (ultravioletIndexValue == UltravioletIndex.MODERATE) 8.00f else 6.00f
                    )

                    drawCircle(
                        alpha = if (ultravioletIndexValue == UltravioletIndex.HIGH) 1.00f else 0.15f,
                        center = Offset(
                            x = 88f,
                            y = 155f,
                        ),
                        color = Orange600,
                        radius = if (ultravioletIndexValue == UltravioletIndex.HIGH) 8.00f else 6.00f
                    )

                    drawCircle(
                        alpha = if (ultravioletIndexValue == UltravioletIndex.VERY_HIGH) 1.00f else 0.15f,
                        center = Offset(
                            x = 120f,
                            y = 145f,
                        ),
                        color = Red800,
                        radius = if (ultravioletIndexValue == UltravioletIndex.VERY_HIGH) 8.00f else 6.00f,
                    )

                    drawCircle(
                        alpha = if (ultravioletIndexValue == UltravioletIndex.EXTREME) 1.00f else 0.15f,
                        center = Offset(
                            x = 144f,
                            y = 121f,
                        ),
                        color = Purple800,
                        radius = if (ultravioletIndexValue == UltravioletIndex.EXTREME) 8.00f else 6.00f,
                    )
                }
            }
            ...
            Column(
                ...
                Header(
                    text = stringResource(R.string.weather_ultraviolet),
                ...
                Text(
                    ...
                    text = "$ultravioletIndex",
                )

                Text(
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    style = MaterialTheme.typography.bodyLarge,
                    text = ultravioletIndexValue.toLabel(context),
                )
