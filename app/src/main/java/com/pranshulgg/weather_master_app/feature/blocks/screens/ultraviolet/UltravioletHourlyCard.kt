...
@Composable
fun UltravioletHourlyCard(
    data: List<WeatherHourly>,
    zoneId: String,
) {
    val maximum = data.maxOf { it.ultraviolet!! }
    val minimum = data.minOf { it.ultraviolet!! }
        ...
        Column(
            ...
            LazyRow(
                ...
                items(
                    ...
                    val item = data[index]
                    val percentage = ((item.ultraviolet!!.minus(minimum)).div((maximum - minimum))).times(100)

                    val barColor = getUltravioletIndex(item.ultraviolet.roundToInt()).toColor()
                    val barHeight =
